#!/bin/bash
#*
#* Please don't edit this file directly, it has been programmatically built or modified with the 'build-qpkgs.sh' script. (source: 'lidarr.source')
#*
#* lidarr.sh
...
readonly r_qpkg_name=Lidarr
readonly r_service_script_version=251031
InitService(){
...
source_url='https://lidarr.servarr.com/v1/update/master/updatefile?os=linux&runtime=netcore&arch='$source_url_arch
