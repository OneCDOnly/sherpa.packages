#!/bin/bash
#*
#* Please don't edit this file directly, it has been programmatically built or modified with the 'build-qpkgs.sh' script. (source: 'sabnzbd.source')
#*
#* sabnzbd.sh
...
readonly r_service_script_version=251023
InitService(){
