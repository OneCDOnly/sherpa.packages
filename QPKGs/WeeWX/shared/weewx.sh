#!/bin/bash
#*
#* Please don't edit this file directly, it was built or modified programmatically with the 'build-qpkgs.sh' script. (source: 'weewx.source')
#*
#* weewx.sh
...
readonly r_service_script_version=260409
InitService(){
