#!/bin/bash
#*
#* Please don't edit this file directly, it has been programmatically built or modified with the 'build-qpkgs.sh' script. (source: 'trailbase.source')
#*
#* trailbase.sh
...
readonly r_service_script_version=251019
InitService(){
...
source_url_match=${source_url_arch}_linux.zip
ui_listening_address=0.0.0.0
ui_port=4000
source_url=https://api.github.com/repos/trailbaseio/trailbase/releases/latest
get_ui_listening_address_cmd="echo $ui_listening_address"
get_ui_port_cmd="echo $ui_port"
get_ui_port_secure_cmd=false
get_ui_port_secure_enabled_test_cmd=false
daemon_launch_cmd="$daemon_exec_pathfile --data-dir $qpkg_config_path run --address $ui_listening_address:$ui_port";}
