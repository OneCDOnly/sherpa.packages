...
source_url_match=linux-${source_url_arch}-filebrowser.tar.gz
...
daemon_launch_cmd="$daemon_exec_pathfile --database $qpkg_config_pathfile --address $($get_ui_listening_address_cmd) --port $($get_ui_port_cmd)";}
