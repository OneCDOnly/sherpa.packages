#!/bin/bash
#*
#* Please don't edit this file directly, it has been programmatically built or modified with the 'build-qpkgs.sh' script. (source: 'lazylibrarian.source')
#*
#* lazylibrarian.sh
...
appl_version_pathfile=$qpkg_repo_path/lazylibrarian/version.py
...
daemon_launch_cmd="$daemon_exec_pathfile $daemon_script_pathfile --daemon --nolaunch --datadir $(/usr/bin/dirname "$qpkg_config_pathfile") --config $qpkg_config_pathfile --pidfile $daemon_pid_pathfile"
