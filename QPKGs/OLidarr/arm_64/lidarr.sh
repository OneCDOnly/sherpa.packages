#!/usr/bin/env bash
#* Please don't edit this file directly, it was built/modified programmatically with the 'build-qpkgs.sh' script. (source: 'lidarr.source')
#* lidarr.sh
...
readonly r_service_script_version='250613'
InitService(){
