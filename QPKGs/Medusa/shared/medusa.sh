#!/bin/bash
#*
#* Please don't edit this file directly, it has been programmatically built or modified with the 'build-qpkgs.sh' script. (source: 'medusa.source')
#*
#* medusa.sh
...
appl_version_pathfile=$qpkg_repo_path/medusa/common.py
