#!/bin/bash
#*
#* Please don't edit this file directly, it was built or modified programmatically with the 'build-qpkgs.sh' script. (source: 'mylar3.source')
#*
#* mylar3.sh
...
daemon_script_pathfile=$qpkg_repo_path/Mylar.py
...
source_git_url=https://github.com/MylarComics/mylar3.git
