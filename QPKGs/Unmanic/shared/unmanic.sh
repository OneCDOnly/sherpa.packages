#!/bin/bash
#*
#* Please don't edit this file directly, it was built or modified programmatically with the 'build-qpkgs.sh' script. (source: 'unmanic.source')
#*
#* unmanic.sh
...
readonly r_service_script_version=260811
InitService(){
