#!/bin/bash
#*
#* Please don't edit this file directly, it has been programmatically built or modified with the 'build-qpkgs.sh' script. (source: 'pyload.source')
#*
#* pyload.sh
...
daemon_launch_cmd="export TEMP=$qpkg_temp_path;$daemon_exec_pathfile $daemon_script_pathfile --userdir $r_qpkg_path/config"
