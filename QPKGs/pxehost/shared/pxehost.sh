#!/bin/bash
#*
#* Please don't edit this file directly, it has been programmatically built or modified with the 'build-qpkgs.sh' script. (source: 'pxehost.source')
#*
#* pxehost.sh
...
readonly r_qpkg_name=pxehost
readonly r_service_script_version=251220
InitService(){
check_network_before_start=true
run_daemon_in_screen_session=true
daemon_port=67
daemon_exec_pathfile=$r_qpkg_path/pxehost
daemon_pid_pathfile=$r_sys_run_path/$r_qpkg_name.pid
daemon_launch_cmd=$r_qpkg_path/pxehost;}
