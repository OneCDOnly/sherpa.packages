#!/bin/bash
#*
#* Please don't edit this file directly, it has been programmatically built or modified with the 'build-qpkgs.sh' script. (source: 'transmission.source')
#*
#* transmission.sh
...
qpkg_config_pathfile=$qpkg_config_path/settings.json
