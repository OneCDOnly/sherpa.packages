#!/bin/bash
#*
#* Please don't edit this file directly, it was built or modified programmatically with the 'build-qpkgs.sh' script. (source: 'copyparty.source')
#*
#* copyparty.sh
...
readonly r_service_script_version=260203
InitService(){
...
daemon_exec_pathfile=$qpkg_venv_path/bin/copyparty
